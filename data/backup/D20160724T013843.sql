-- HbDataPHP v1.x SQL Dump Program
-- http://localhost/hbdata/
-- 
-- DATE : 2016-07-24 01:38:50
-- MYSQL SERVER VERSION : 5.7.13
-- PHP VERSION : 5.5.30
-- HbDataPHP VERSION : v1.0 Release 20160705

DROP TABLE IF EXISTS `hbdata_admin`;
CREATE TABLE `hbdata_admin` (
...
INSERT INTO hbdata_admin VALUES('1','root','','e10adc3949ba59abbe56e057f20f883e','ALL','1469291180','1469291749','127.0.0.1');

DROP TABLE IF EXISTS `hbdata_admin_log`;
CREATE TABLE `hbdata_admin_log` (
...
INSERT INTO hbdata_admin_log VALUES('1','1381887740','1','系统设置: 编辑成功','127.0.0.1');
INSERT INTO hbdata_admin_log VALUES('2','1381887745','1','编辑导航: 公司简介','127.0.0.1');
INSERT INTO hbdata_admin_log VALUES('3','1381887749','1','编辑幻灯: 广告图片01','127.0.0.1');
INSERT INTO hbdata_admin_log VALUES('4','1381887753','1','编辑单页面: 联系我们','127.0.0.1');
INSERT INTO hbdata_admin_log VALUES('5','1381887756','1','编辑商品分类: 电子数码','127.0.0.1');
INSERT INTO hbdata_admin_log VALUES('6','1381887759','1','编辑文章分类: 公司动态','127.0.0.1');
INSERT INTO hbdata_admin_log VALUES('7','1381887775','1','编辑单页面: 企业荣誉','127.0.0.1');
INSERT INTO hbdata_admin_log VALUES('8','1381887778','1','编辑单页面: 公司简介','127.0.0.1');
INSERT INTO hbdata_admin_log VALUES('9','1381887781','1','编辑单页面: 营销网络','127.0.0.1');
INSERT INTO hbdata_admin_log VALUES('10','1469291749','1','管理员登录: 登录成功！','127.0.0.1');

DROP TABLE IF EXISTS `hbdata_article`;
CREATE TABLE `hbdata_article` (
...
DROP TABLE IF EXISTS `hbdata_config`;
CREATE TABLE `hbdata_config` (
...
INSERT INTO hbdata_config VALUES('site_name','hbdataPHP轻量级企业网站管理系统','text','','main','1');
INSERT INTO hbdata_config VALUES('site_title','hbdataPHP轻量级企业网站管理系统','text','','main','2');
INSERT INTO hbdata_config VALUES('site_keywords','hbdataPHP,轻量级企业网站管理系统','text','','main','3');
INSERT INTO hbdata_config VALUES('site_description','hbdataPHP,轻量级企业网站管理系统','text','','main','4');
INSERT INTO hbdata_config VALUES('site_logo','logo.png','file','','main','5');
INSERT INTO hbdata_config VALUES('site_address','福建省漳州市芗城区','text','','main','6');
INSERT INTO hbdata_config VALUES('site_closed','0','radio','','main','7');
INSERT INTO hbdata_config VALUES('icp','','text','','main','8');
INSERT INTO hbdata_config VALUES('tel','0596-8888888','text','','main','9');
INSERT INTO hbdata_config VALUES('fax','0596-6666666','text','','main','10');
INSERT INTO hbdata_config VALUES('qq','','text','','main','11');
INSERT INTO hbdata_config VALUES('email','your@domain.com','text','','main','12');
INSERT INTO hbdata_config VALUES('language','zh_cn','select','','main','13');
INSERT INTO hbdata_config VALUES('rewrite','0','radio','','main','14');
INSERT INTO hbdata_config VALUES('sitemap','1','radio','','main','15');
INSERT INTO hbdata_config VALUES('captcha','1','radio','','main','16');
INSERT INTO hbdata_config VALUES('guestbook_check_chinese','1','radio','','main','17');
INSERT INTO hbdata_config VALUES('code','','textarea','','main','18');
INSERT INTO hbdata_config VALUES('thumb_width','135','text','','display','1');
INSERT INTO hbdata_config VALUES('thumb_height','135','text','','display','2');
INSERT INTO hbdata_config VALUES('price_decimal','2','text','','display','3');
INSERT INTO hbdata_config VALUES('display','a:4:{s:7:\"article\";s:2:\"10\";s:12:\"home_article\";s:1:\"5\";s:7:\"product\";s:2:\"10\";s:12:\"home_product\";s:1:\"4\";}','array','','display','4');
INSERT INTO hbdata_config VALUES('defined','a:2:{s:7:\"article\";s:0:\"\";s:7:\"product\";s:0:\"\";}','array','','defined','1');
INSERT INTO hbdata_config VALUES('mail_service','0','radio','','mail','1');
INSERT INTO hbdata_config VALUES('mail_host','smtp.domain.com','text','','mail','2');
INSERT INTO hbdata_config VALUES('mail_port','25','text','','mail','3');
INSERT INTO hbdata_config VALUES('mail_ssl','0','radio','','mail','4');
INSERT INTO hbdata_config VALUES('mail_username','','text','','mail','5');
INSERT INTO hbdata_config VALUES('mail_password','','text','','mail','6');
INSERT INTO hbdata_config VALUES('mobile_name','hbdataPHP','text','','mobile','1');
INSERT INTO hbdata_config VALUES('mobile_title','hbdataPHP触屏版','text','','mobile','2');
INSERT INTO hbdata_config VALUES('mobile_keywords','hbdataPHP,hbdataPHP触屏版','text','','mobile','3');
INSERT INTO hbdata_config VALUES('mobile_description','hbdataPHP,hbdataPHP触屏版','text','','mobile','4');
INSERT INTO hbdata_config VALUES('mobile_logo','','file','','mobile','5');
INSERT INTO hbdata_config VALUES('mobile_closed','0','radio','','mobile','6');
INSERT INTO hbdata_config VALUES('mobile_display','a:4:{s:7:\"article\";i:10;s:12:\"home_article\";i:5;s:7:\"product\";i:10;s:12:\"home_product\";i:4;}','array','','mobile','7');
INSERT INTO hbdata_config VALUES('site_theme','default','hidden','','','100');
INSERT INTO hbdata_config VALUES('mobile_theme','default','hidden','','','101');
INSERT INTO hbdata_config VALUES('build_date','1469291183','hidden','','','102');
INSERT INTO hbdata_config VALUES('update_number','a:6:{s:6:\"update\";s:1:\"0\";s:5:\"patch\";s:1:\"0\";s:6:\"module\";s:1:\"0\";s:6:\"plugin\";s:1:\"0\";s:5:\"theme\";s:1:\"0\";s:6:\"mobile\";N;}','hidden','','','103');
INSERT INTO hbdata_config VALUES('update_date','a:2:{s:6:\"system\";a:2:{s:6:\"update\";i:20160705;s:5:\"patch\";i:20160705;}s:6:\"module\";a:2:{s:7:\"article\";i:20160705;s:7:\"product\";i:20160705;}}','hidden','','','104');
INSERT INTO hbdata_config VALUES('cloud_account','','hidden','','','105');
INSERT INTO hbdata_config VALUES('hash_code','74e624068fc6bb86e8d5f491668e93e2','hidden','','','106');
INSERT INTO hbdata_config VALUES('hbdataphp_version','v1.0 Release 20160705','hidden','','','107');

DROP TABLE IF EXISTS `hbdata_game`;
CREATE TABLE `hbdata_game` (
  `id` mediumint(8) unsigned NOT NULL AUTO_INCREMENT,
  `cat_id` smallint(5) NOT NULL DEFAULT '0',
  `title` varchar(150) NOT NULL DEFAULT '',
  `defined` text NOT NULL,
...
INSERT INTO hbdata_nav VALUES('1','page','公司简介','1','0','middle','10');
INSERT INTO hbdata_nav VALUES('2','page','企业荣誉','2','1','middle','10');
INSERT INTO hbdata_nav VALUES('3','page','发展历程','3','1','middle','20');
INSERT INTO hbdata_nav VALUES('4','page','联系我们','4','1','middle','30');
INSERT INTO hbdata_nav VALUES('5','product_category','产品中心','0','0','middle','20');
INSERT INTO hbdata_nav VALUES('6','article_category','文章中心','0','0','middle','30');
INSERT INTO hbdata_nav VALUES('7','page','营销网络','6','0','middle','40');
INSERT INTO hbdata_nav VALUES('8','page','人才招聘','5','0','middle','60');
INSERT INTO hbdata_nav VALUES('9','page','联系我们','4','0','middle','70');
INSERT INTO hbdata_nav VALUES('10','product_category','电子数码','3','5','middle','10');
INSERT INTO hbdata_nav VALUES('11','product_category','家居百货','4','5','middle','20');
INSERT INTO hbdata_nav VALUES('12','product_category','母婴用品','3','5','middle','30');
INSERT INTO hbdata_nav VALUES('13','article_category','公司动态','1','6','middle','10');
INSERT INTO hbdata_nav VALUES('14','article_category','行业新闻','2','6','middle','20');
INSERT INTO hbdata_nav VALUES('15','page','企业荣誉','2','0','middle','50');
INSERT INTO hbdata_nav VALUES('17','page','公司简介','1','0','bottom','10');
INSERT INTO hbdata_nav VALUES('18','page','营销网络','6','0','bottom','20');
INSERT INTO hbdata_nav VALUES('19','page','企业荣誉','2','0','bottom','30');
INSERT INTO hbdata_nav VALUES('20','page','人才招聘','5','0','bottom','40');
INSERT INTO hbdata_nav VALUES('21','page','联系我们','4','0','bottom','50');
INSERT INTO hbdata_nav VALUES('22','product_category','智能手机','6','10','middle','1');
INSERT INTO hbdata_nav VALUES('23','product_category','平板电脑','7','10','middle','2');
INSERT INTO hbdata_nav VALUES('25','page','公司简介','1','0','mobile','10');
INSERT INTO hbdata_nav VALUES('26','product_category','产品中心','0','0','mobile','20');
INSERT INTO hbdata_nav VALUES('27','article_category','文章中心','0','0','mobile','30');
INSERT INTO hbdata_nav VALUES('28','page','企业荣誉','2','0','mobile','40');
INSERT INTO hbdata_nav VALUES('29','page','营销网络','6','0','mobile','50');
INSERT INTO hbdata_nav VALUES('30','page','人才招聘','5','0','mobile','60');
...
INSERT INTO hbdata_page VALUES('1','about','0','公司简介','hbdataPHP 是一款轻量级企业网站管理系统，基于PHP+Mysql架构的，可运行在Linux、Windows、MacOSX、Solaris等各种平台上，系统搭载Smarty模板引擎，支持自定义伪静态，前台模板采用DIV+CSS设计，后台界面设计简洁明了，功能简单易具有良好的用户体验，稳定性好、扩展性及安全性强，可面向中小型站点提供网站建设解决方案。','公司简介','hbdataPHP是一款轻量级企业网站管理系统，基于PHP+Mysql架构的，可运行在Linux、Windows、MacOSX、Solaris等各种平台上，系统搭载Smarty模板引擎，支持自定义伪静态，前台模板采用DIV+CSS设计，后台界面设计简洁明了，功能简单易具有良好的用户体验，稳定性好、扩展性及安全性强，可面向中小型站点提供网站建设解决方案。','10');
INSERT INTO hbdata_page VALUES('2','honor','1','企业荣誉','企业荣誉','企业荣誉','企业荣誉','20');
INSERT INTO hbdata_page VALUES('3','history','1','发展历程','发展历程','发展历程','发展历程','30');
INSERT INTO hbdata_page VALUES('4','contact','1','联系我们','通讯地址：<br />\r\n<span style=\"color:#D7D7D7;\">--------------------------------------------------------------------------------------------------------------------------------</span><br />\r\n福建省漳州市芗城区，邮编363000<br />\r\n<br />\r\n客服邮箱：<br />\r\n<span style=\"color:#D7D7D7;\">--------------------------------------------------------------------------------------------------------------------------------</span><br />\r\nhbdataPHP售后服务邮箱：email@email.com<br />\r\nhbdataPHP业务受理邮箱：<span>email@email.com</span><br />\r\n如您需要订制开发请在邮件中注明您的大概要求，我们将在一个工作日内给予回复。<br />\r\n<br />\r\n客服电话：<br />\r\n<span style=\"color:#D7D7D7;\">--------------------------------------------------------------------------------------------------------------------------------</span><br />\r\n<span>hbdataPHP</span>的建站咨询电话为 0596-1234567。<br />\r\n客服电话工作时间为周一至周日 8:00-20:00，节假日不休息，免长途话费。<br />\r\n我们将随时为您献上真诚的服务。<br />\r\n<br />\r\n网站网址：<br />\r\n<span style=\"color:#D7D7D7;\">--------------------------------------------------------------------------------------------------------------------------------</span><br />\r\nwww.zhihu.com<br />','联系我们','联系我们','40');
INSERT INTO hbdata_page VALUES('5','job','0','人才招聘','人才招聘','人才招聘','人才招聘','50');
INSERT INTO hbdata_page VALUES('6','market','0','营销网络','营销网络','营销网络','营销网络','60');

DROP TABLE IF EXISTS `hbdata_permissions`;
CREATE TABLE `hbdata_permissions` (
...
INSERT INTO hbdata_permissions VALUES('1','0','279','root','root');
INSERT INTO hbdata_permissions VALUES('2','1','6','admin/','网站根目录');
INSERT INTO hbdata_permissions VALUES('3','2','3','admin/index.php','网站根目录');
INSERT INTO hbdata_permissions VALUES('4','7','12','admin/system.php?manage','系统设置');
INSERT INTO hbdata_permissions VALUES('5','8','9','admin/system.php','查看系统设置');
INSERT INTO hbdata_permissions VALUES('6','10','11','admin/system.php?rec=update','系统设置更新');
INSERT INTO hbdata_permissions VALUES('7','13','34','admin/nav.php?manage','自定义导航栏');
INSERT INTO hbdata_permissions VALUES('8','32','33','admin/nav.php','查看导航栏');
INSERT INTO hbdata_permissions VALUES('9','14','15','admin/nav.php?rec=add','添加导航栏页面');
INSERT INTO hbdata_permissions VALUES('10','16','17','admin/nav.php?rec=insert','添加导航栏');
INSERT INTO hbdata_permissions VALUES('11','18','19','admin/nav.php?rec=edit','编辑导航栏页面');
INSERT INTO hbdata_permissions VALUES('12','20','21','admin/nav.php?rec=update','更新导航栏');
INSERT INTO hbdata_permissions VALUES('13','22','23','admin/nav.php?type=top','切换到顶部导航栏编辑界面');
INSERT INTO hbdata_permissions VALUES('14','24','25','admin/nav.php?type=bottom','切换到底部导航栏编辑界面');
INSERT INTO hbdata_permissions VALUES('15','26','27','admin/nav.php?type=middle','切换到中部导航栏编辑界面');
INSERT INTO hbdata_permissions VALUES('16','28','29','admin/nav.php?rec=del','删除一个导航栏');
INSERT INTO hbdata_permissions VALUES('17','30','31','admin/nav.php?rec=nav_select','添加导航时动态切换导航');
INSERT INTO hbdata_permissions VALUES('18','35','46','admin/show.php?manage','首页幻灯广告');
INSERT INTO hbdata_permissions VALUES('19','44','45','admin/show.php','查看幻灯广告');
INSERT INTO hbdata_permissions VALUES('20','36','37','admin/show.php?rec=insert','添加幻灯广告');
INSERT INTO hbdata_permissions VALUES('21','38','39','admin/show.php?rec=update','更新幻灯广告');
INSERT INTO hbdata_permissions VALUES('22','40','41','admin/show.php?rec=edit','编辑幻灯广告');
INSERT INTO hbdata_permissions VALUES('23','42','43','admin/show.php?rec=del','删除幻灯广告');
INSERT INTO hbdata_permissions VALUES('24','47','114','admin/page.php?manage','单页面管理');
INSERT INTO hbdata_permissions VALUES('25','48','49','admin/page.php','单页面浏览');
INSERT INTO hbdata_permissions VALUES('26','50','51','admin/page.php?rec=add','添加单页面');
INSERT INTO hbdata_permissions VALUES('27','52','53','admin/page.php?rec=insert','插入单页面');
INSERT INTO hbdata_permissions VALUES('28','54','93','admin/page.php?name=about&manage','公司简介');
INSERT INTO hbdata_permissions VALUES('29','89','90','admin/page.php?name=about','查看公司简介');
INSERT INTO hbdata_permissions VALUES('30','55','56','admin/page.php?name=about&rec=edit','编辑公司简介');
INSERT INTO hbdata_permissions VALUES('31','91','92','admin/page.php?name=about&rec=update','更新公司简介');
INSERT INTO hbdata_permissions VALUES('32','57','58','admin/page.php?name=about&rec=del','删除公司简介');
INSERT INTO hbdata_permissions VALUES('33','59','68','admin/page.php?name=honor&manage','企业荣誉');
INSERT INTO hbdata_permissions VALUES('34','64','65','admin/page.php?name=honor','查看企业荣誉');
INSERT INTO hbdata_permissions VALUES('35','60','61','admin/page.php?name=honor&rec=edit','编辑企业荣誉');
INSERT INTO hbdata_permissions VALUES('36','66','67','admin/page.php?name=honor&rec=update','更新企业荣誉');
INSERT INTO hbdata_permissions VALUES('37','62','63','admin/page.php?name=honor&rec=del','删除企业荣誉');
INSERT INTO hbdata_permissions VALUES('38','69','78','admin/page.php?name=history&manage','发展历程');
INSERT INTO hbdata_permissions VALUES('39','74','75','admin/page.php?name=history','查看发展历程');
INSERT INTO hbdata_permissions VALUES('40','70','71','admin/page.php?name=history&rec=edit','编辑发展历程');
INSERT INTO hbdata_permissions VALUES('41','76','77','admin/page.php?name=history&rec=update','更新发展历程');
INSERT INTO hbdata_permissions VALUES('42','72','73','admin/page.php?name=history&rec=del','删除发展历程');
INSERT INTO hbdata_permissions VALUES('43','79','88','admin/page.php?name=contact&manage','联系我们');
INSERT INTO hbdata_permissions VALUES('44','84','85','admin/page.php?name=contact','查看联系我们');
INSERT INTO hbdata_permissions VALUES('45','80','81','admin/page.php?name=contact&rec=edit','编辑联系我们');
INSERT INTO hbdata_permissions VALUES('46','86','87','admin/page.php?name=contact&rec=update','更新联系我们');
INSERT INTO hbdata_permissions VALUES('47','82','83','admin/page.php?name=contact&rec=del','删除联系我们');
INSERT INTO hbdata_permissions VALUES('48','94','103','admin/page.php?name=job&manage','人才招聘');
INSERT INTO hbdata_permissions VALUES('49','99','100','admin/page.php?name=job','查看人才招聘');
INSERT INTO hbdata_permissions VALUES('50','95','96','admin/page.php?name=job&rec=edit','编辑人才招聘');
INSERT INTO hbdata_permissions VALUES('51','101','102','admin/page.php?name=job&rec=update','更新人才招聘');
INSERT INTO hbdata_permissions VALUES('52','97','98','admin/page.php?name=job&rec=del','删除人才招聘');
INSERT INTO hbdata_permissions VALUES('53','104','113','admin/page.php?name=market&manage','营销网络');
INSERT INTO hbdata_permissions VALUES('54','109','110','admin/page.php?name=market','查看营销网络');
INSERT INTO hbdata_permissions VALUES('55','105','106','admin/page.php?name=market&rec=edit','编辑营销网络');
INSERT INTO hbdata_permissions VALUES('56','111','112','admin/page.php?name=market&rec=update','更新营销网络');
INSERT INTO hbdata_permissions VALUES('57','107','108','admin/page.php?name=market&rec=del','删除营销网络');
INSERT INTO hbdata_permissions VALUES('58','115','128','admin/category_manage.php?manage','分类管理');
INSERT INTO hbdata_permissions VALUES('59','126','127','admin/category_manage.php','查看分类管理');
INSERT INTO hbdata_permissions VALUES('60','116','117','admin/category_manage.php?rec=add','添加分类');
INSERT INTO hbdata_permissions VALUES('61','118','119','admin/category_manage.php?rec=insert','插入分类');
INSERT INTO hbdata_permissions VALUES('62','120','121','admin/category_manage.php?rec=update','更新分类');
INSERT INTO hbdata_permissions VALUES('63','122','123','admin/category_manage.php?rec=edit','编辑分类');
INSERT INTO hbdata_permissions VALUES('64','124','125','admin/category_manage.php?rec=del','删除分类');
INSERT INTO hbdata_permissions VALUES('65','129','142','admin/backup.php?manage','备份管理');
INSERT INTO hbdata_permissions VALUES('66','140','141','admin/backup.php','查看备份情况');
INSERT INTO hbdata_permissions VALUES('67','130','131','admin/backup.php?rec=backup','备份');
INSERT INTO hbdata_permissions VALUES('68','132','133','admin/backup.php?rec=restore','恢复备份');
INSERT INTO hbdata_permissions VALUES('69','134','135','admin/backup.php?rec=import','导入备份');
INSERT INTO hbdata_permissions VALUES('70','136','137','admin/backup.php?rec=del','删除备份');
INSERT INTO hbdata_permissions VALUES('71','138','139','admin/backup.php?rec=down','下载备份');
INSERT INTO hbdata_permissions VALUES('72','143','150','admin/theme.php?manage','设置模板');
INSERT INTO hbdata_permissions VALUES('73','148','149','admin/theme.php','查看模板');
INSERT INTO hbdata_permissions VALUES('74','144','145','admin/theme.php?rec=enable','开启模板');
INSERT INTO hbdata_permissions VALUES('75','146','147','admin/theme.php?rec=del','删除模板');
INSERT INTO hbdata_permissions VALUES('76','151','170','admin/manager.php?manage','用户管理');
INSERT INTO hbdata_permissions VALUES('77','168','169','admin/manager.php','查看用户');
INSERT INTO hbdata_permissions VALUES('78','152','153','admin/manager.php?rec=add','添加用户');
INSERT INTO hbdata_permissions VALUES('79','154','155','admin/manager.php?rec=insert','插入用户');
INSERT INTO hbdata_permissions VALUES('80','156','157','admin/manager.php?rec=update','更新用户');
INSERT INTO hbdata_permissions VALUES('81','158','159','admin/manager.php?rec=edit','编辑用户');
INSERT INTO hbdata_permissions VALUES('82','160','161','admin/manager.php?rec=del','删除用户');
INSERT INTO hbdata_permissions VALUES('83','162','163','admin/manager.php?rec=manager_log','操作日志');
INSERT INTO hbdata_permissions VALUES('84','164','165','admin/manager.php?rec=edit_user_role','编辑用户角色');
INSERT INTO hbdata_permissions VALUES('85','166','167','admin/manager.php?rec=update_user_role','更新用户角色');
INSERT INTO hbdata_permissions VALUES('86','171','188','admin/role.php?manage','角色管理');
INSERT INTO hbdata_permissions VALUES('87','186','187','admin/role.php','查看角色');
INSERT INTO hbdata_permissions VALUES('88','172','173','admin/role.php?rec=add','添加角色');
INSERT INTO hbdata_permissions VALUES('89','174','175','admin/role.php?rec=insert','插入角色');
INSERT INTO hbdata_permissions VALUES('90','176','177','admin/role.php?rec=update','更新角色');
INSERT INTO hbdata_permissions VALUES('91','178','179','admin/role.php?rec=edit','编辑角色');
INSERT INTO hbdata_permissions VALUES('92','180','181','admin/role.php?rec=del','删除角色');
INSERT INTO hbdata_permissions VALUES('93','182','183','admin/role.php?rec=edit_role_permission','编辑角色权限');
INSERT INTO hbdata_permissions VALUES('94','184','185','admin/role.php?rec=update_role_permission','更新角色权限');
INSERT INTO hbdata_permissions VALUES('95','189','200','admin/guestbook.php?manage','留言反馈');
INSERT INTO hbdata_permissions VALUES('96','198','199','admin/guestbook.php','查看留言');
INSERT INTO hbdata_permissions VALUES('97','190','191','admin/guestbook.php?rec=read','阅读留言');
INSERT INTO hbdata_permissions VALUES('98','192','193','admin/guestbook.php?rec=reply','回复留言');
INSERT INTO hbdata_permissions VALUES('99','194','195','admin/guestbook.php?rec=show_hidden','显示或隐藏留言');
INSERT INTO hbdata_permissions VALUES('100','196','197','admin/guestbook.php?rec=del_all','删除留言');
INSERT INTO hbdata_permissions VALUES('101','201','230','admin/item_category.php','分类管理');
INSERT INTO hbdata_permissions VALUES('102','202','215','admin/item_category.php?module=product&manage','商品分类管理');
INSERT INTO hbdata_permissions VALUES('103','213','214','admin/item_category.php?module=product','查看商品分类');
INSERT INTO hbdata_permissions VALUES('104','203','204','admin/item_category.php?module=product&rec=add','添加商品分类');
INSERT INTO hbdata_permissions VALUES('105','205','206','admin/item_category.php?module=product&rec=insert','插入商品分类');
INSERT INTO hbdata_permissions VALUES('106','207','208','admin/item_category.php?module=product&rec=update','更新商品分类');
INSERT INTO hbdata_permissions VALUES('107','209','210','admin/item_category.php?module=product&rec=edit','编辑商品分类');
INSERT INTO hbdata_permissions VALUES('108','211','212','admin/item_category.php?module=product&rec=del','删除商品分类');
INSERT INTO hbdata_permissions VALUES('109','216','229','admin/item_category.php?module=article&manage','文章分类管理');
INSERT INTO hbdata_permissions VALUES('110','227','228','admin/item_category.php?module=article','查看文章分类');
INSERT INTO hbdata_permissions VALUES('111','217','218','admin/item_category.php?module=article&rec=add','添加文章分类');
INSERT INTO hbdata_permissions VALUES('112','219','220','admin/item_category.php?module=article&rec=insert','插入文章分类');
INSERT INTO hbdata_permissions VALUES('113','221','222','admin/item_category.php?module=article&rec=update','更新文章分类');
INSERT INTO hbdata_permissions VALUES('114','223','224','admin/item_category.php?module=article&rec=edit','编辑文章分类');
INSERT INTO hbdata_permissions VALUES('115','225','226','admin/item_category.php?module=article&rec=del','删除文章分类');
INSERT INTO hbdata_permissions VALUES('116','231','278','admin/item.php','分类项管理');
INSERT INTO hbdata_permissions VALUES('117','232','255','admin/item.php?module=product&manage','商品管理');
INSERT INTO hbdata_permissions VALUES('118','253','254','admin/item.php?module=product','查看商品');
INSERT INTO hbdata_permissions VALUES('119','233','234','admin/item.php?module=product&rec=add','添加商品');
INSERT INTO hbdata_permissions VALUES('120','235','236','admin/item.php?module=product&rec=insert','插入商品');
INSERT INTO hbdata_permissions VALUES('121','237','238','admin/item.php?module=product&rec=update','更新商品');
INSERT INTO hbdata_permissions VALUES('122','239','240','admin/item.php?module=product&rec=edit','编辑商品');
INSERT INTO hbdata_permissions VALUES('123','241','242','admin/item.php?module=product&rec=del','删除商品');
INSERT INTO hbdata_permissions VALUES('124','243','244','admin/item.php?module=product&rec=re_thumb','重新生成商品略缩图');
INSERT INTO hbdata_permissions VALUES('125','245','246','admin/item.php?module=product&rec=sort','筛选商品');
INSERT INTO hbdata_permissions VALUES('126','247','248','admin/item.php?module=product&rec=set_sort','设置首页显示商品');
INSERT INTO hbdata_permissions VALUES('127','249','250','admin/item.php?module=product&rec=del_sort','取消首页显示商品');
INSERT INTO hbdata_permissions VALUES('128','251','252','admin/item.php?module=product&rec=action','批量操作商品');
INSERT INTO hbdata_permissions VALUES('129','256','277','admin/item.php?module=article&manage','文章管理');
INSERT INTO hbdata_permissions VALUES('130','275','276','admin/item.php?module=article','查看文章');
INSERT INTO hbdata_permissions VALUES('131','257','258','admin/item.php?module=article&rec=add','添加文章');
INSERT INTO hbdata_permissions VALUES('132','259','260','admin/item.php?module=article&rec=insert','插入文章');
INSERT INTO hbdata_permissions VALUES('133','261','262','admin/item.php?module=article&rec=update','更新文章');
INSERT INTO hbdata_permissions VALUES('134','263','264','admin/item.php?module=article&rec=edit','编辑文章');
INSERT INTO hbdata_permissions VALUES('135','265','266','admin/item.php?module=article&rec=del','删除文章');
INSERT INTO hbdata_permissions VALUES('136','267','268','admin/item.php?module=article&rec=sort','筛选文章');
INSERT INTO hbdata_permissions VALUES('137','269','270','admin/item.php?module=article&rec=set_sort','设置首页显示文章');
INSERT INTO hbdata_permissions VALUES('138','271','272','admin/item.php?module=article&rec=del_sort','取消首页显示文章');
INSERT INTO hbdata_permissions VALUES('139','273','274','admin/item.php?module=article&rec=action','批量操作文章');
INSERT INTO hbdata_permissions VALUES('140','4','5','admin/index.php?rec=clear_cache','清除缓存');

DROP TABLE IF EXISTS `hbdata_product`;
CREATE TABLE `hbdata_product` (
  `id` mediumint(8) unsigned NOT NULL AUTO_INCREMENT,
  `cat_id` smallint(5) NOT NULL DEFAULT '0',
...
DROP TABLE IF EXISTS `hbdata_show`;
CREATE TABLE `hbdata_show` (
...
INSERT INTO hbdata_show VALUES('1','广告图片01','http://www.baidu.com','data/slide/slide1.jpg','pc','1');
INSERT INTO hbdata_show VALUES('2','广告图片02','http://www.baidu.com','data/slide/slide2.jpg','pc','2');
INSERT INTO hbdata_show VALUES('3','广告图片03','http://www.baidu.com','data/slide/slide3.jpg','pc','3');
INSERT INTO hbdata_show VALUES('4','广告图片04','http://www.baidu.com','data/slide/slide4.jpg','pc','4');
INSERT INTO hbdata_show VALUES('5','手机版广告图片01','http://m.baidu.com','data/slide/m/slide1.jpg','mobile','10');
INSERT INTO hbdata_show VALUES('6','手机版广告图片02','http://m.baidu.com','data/slide/m/slide2.jpg','mobile','20');
